...
class Profile extends Component {
  constructor() {
    ...
    this.userEventData = this.userEventData.bind(
      this,
    );
    this.renderUserEvents = this.renderUserEvents.bind(
      this,
    );
    this.renderUserAttendingEvents = this.renderUserAttendingEvents.bind(
      this,
    );
  }
    ...
    return (
      <div>
        ...
        <div>
          ...
          {this.state.ready
            ? this.renderUserAttendingEvents(
